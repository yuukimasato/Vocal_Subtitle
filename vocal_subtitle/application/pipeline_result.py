"""Pipeline statistics, serialization and result contract.

Provides PipelineStats as a pure data object — no model calls, no pipeline imports.
Separated from pipeline.py to keep the orchestrator from holding data definitions.
"""
...
class PipelineStats:
    ...
    asr_review_diagnostics: Dict[str, Any] = field(default_factory=dict)
    ...
    def to_dict(self) -> dict:
        result = {
            ...
            "asr_review_diagnostics": self.asr_review_diagnostics,
        }
    ...
    def from_dict(
        ...
        stats.hallucination_filter_version = payload.get("hallucination_filter_version", "")
        stats.hallucination_dropped_count = payload.get("hallucination_dropped_count", 0)
        stats.hallucination_drop_reasons = payload.get("hallucination_drop_reasons", {})
        stats.asr_review_diagnostics = payload.get("asr_review_diagnostics", {})
