...
class TestBuildReviewManifest:
    ...
    def test_cue_provenance_fields(self, tmp_path):
        ...
        events = [
            _event(
                ...
                speaker_label="主持人",
                words=[
                    {"word": "大", "start": 0.0, "end": 0.2, "confidence": 0.9},
        ...
        manifest = build_review_manifest(
            task_id="t", run_id="r", subtitle_path=subtitle, events=events
        )
    ...
    def test_optional_top_level_fields(self, tmp_path):
        ...
        manifest = build_review_manifest(
            ...
            subtitle_path=subtitle,
            events=[],
            input_name="lesson01.mp4",
            input_sha256="abc",
            duration=3600.0,
            profile="default",
            engines={"asr": "funasr", "vad": ""},
        )
...
class TestPersistenceWiring:
    def test_persist_task_writes_manifest(self, tmp_path):
        ...
        task_result = {
            ...
            "events": [
                _event(1, 1.0, 2.0, "你好", speaker_id=0, speaker_label="主持人")
            ],
        }
